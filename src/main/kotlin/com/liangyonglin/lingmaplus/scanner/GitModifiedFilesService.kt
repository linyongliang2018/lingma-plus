...
object GitModifiedFilesService {
    ...
    fun getModifiedJavaFiles(projectBasePath: String?, daysBack: Int, author: String): List<String> {
        ...
        val cmd = buildGitCommand(daysBack, effectiveAuthor)
        ...
        return try {
            ...
            if (!exited || process.exitValue() != 0) {
                logger.warn("Git 命令执行异常: exit=${process.exitValue()}, output=$output")
                return emptyList()
            }
    ...
    private fun buildGitCommand(daysBack: Int, author: String): List<String> {
